...
EXAMPLE_DIRECTORIES = ['traffic-control', 'udp-client-server', 'routing', 'matrix-topology', 'ipv6', 'energy', 'realtime', 'wireless', 'naming', 'tutorial', 'tcp', 'error-model', 'socket', 'udp', 'stats']
