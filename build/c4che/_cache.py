...
EXAMPLE_DIRECTORIES = ['wireless', 'udp', 'ipv6', 'tutorial', 'tcp', 'energy', 'realtime', 'udp-client-server', 'routing', 'error-model', 'socket', 'stats', 'traffic-control', 'matrix-topology', 'naming']
