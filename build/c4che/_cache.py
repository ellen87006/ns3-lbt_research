...
EXAMPLE_DIRECTORIES = ['tcp', 'traffic-control', 'matrix-topology', 'tutorial', 'udp', 'ipv6', 'wireless', 'routing', 'socket', 'realtime', 'error-model', 'energy', 'naming', 'stats', 'udp-client-server']
