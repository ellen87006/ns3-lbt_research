...
\GNUPLOTpicture(7200,5040)
  \special{psfile=images/pstex/indoor_-82_0_ftpLambda_2_5_Wifi_rule_all_latency_hi_res.ps llx=0 lly=0 urx=360 ury=252 rwi=3600}
  \put(5873,803){\rjust{\strut{}NACK rule operator B}}%
  \put(5873,1003){\rjust{\strut{}NACK rule operator A}}%
