...
\GNUPLOTpicture(7200,5040)
  \special{psfile=images/pstex/indoor_-82_0_ftpLambda_1_5_Wifi_rule_any_latency_hi_res.ps llx=0 lly=0 urx=360 ury=252 rwi=3600}
  \put(5873,803){\rjust{\strut{}Before rule operator B}}%
  \put(5873,1003){\rjust{\strut{}Before rule operator A}}%
