 ...
 set output "images/ps/indoor_ftpLambda_0_8_operatorA_throughput.eps" 
 ...
 unset title
 plot [0:1][70:140] "results/cdf_throughput_eD_-82.0_ftpLambda_0.8_cellA_Laa_rule_all_A" using ($2):($1)  with linespoints ls 1  title "NACK rule operator Laa"  , "results/cdf_throughput_eD_-82.0_ftpLambda_0.8_cellA_Laa_rule_any_A" using ($2):($1)  with linespoints ls 2  title "Before rule operator Laa"  , "results/cdf_throughput_eD_-82.0_ftpLambda_0.8_cellA_Laa_rule_nacks10_A" using ($2):($1)  with linespoints ls 3  title "LBT operator Laa"  , "results/cdf_throughput_eD_-82.0_ftpLambda_0.8_cellA_Laa_rule_nacks80_A" using ($2):($1)  with linespoints ls 4  title "LBT fixed operator Laa"  , "results/cdf_throughput_eD_-82.0_ftpLambda_0.8_cellA_Wifi_rule_nacks10_A" using ($2):($1)  with linespoints ls 5  title "haha operator A"  
